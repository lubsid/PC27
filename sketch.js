...
function setup() {
	...
	rope1=new rope({x:width/2-80,y:height/4},bobObject1.body)
	rope2=new rope({x:width/2-40,y:height/4},bobObject2.body)
	rope3=new rope({x:width/2,y:height/4},bobObject3.body)
	rope4=new rope({x:width/2+40,y:height/4},bobObject4.body)
	rope5=new rope({x:width/2+80,y:height/4},bobObject5.body)
